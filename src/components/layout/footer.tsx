	...
	return (
		<footer className="border-t border-neutral-200 dark:border-neutral-800">
			<div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-4 py-8 sm:flex-row sm:justify-between">
				...
				<div className="flex items-center gap-3">
					{socialLinks.map((link) => (
						<a
							...
							className="rounded-md p-2 text-neutral-400 transition-colors hover:bg-neutral-100 hover:text-neutral-700 dark:hover:bg-neutral-800 dark:hover:text-neutral-300"
				...
				{/* Build credit */}
				<p className="text-sm text-neutral-400">{t("footer.madeWith")}</p>
			</div>
		</footer>
	);
}
